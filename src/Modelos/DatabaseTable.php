 ...
 *
 * @author Cristina Caluña
 * @link  https://github.com/CristinaCaluna/FEDEPROBAB.git
 */
abstract class DatabaseTable extends Model
{
     ...
     */
    public function select(bool $orden = false, ?string $columna = null, string $forma = 'asc', array $columnas = []): \Illuminate\Support\Collection
    {
        $resultado = DB::table($this->table)
        ->select();
