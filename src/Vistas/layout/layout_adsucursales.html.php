    ...
    <header class="p-3 text-white" style="background-color: red;">
        ...
        <dIv class ="mx-2 "><front face="arial"> <h1  style="color:aliceblue fs-1 ">FEDEPROBAB</h1> </front></dIv>
            ...
            <ul class="nav mx-auto col-lg-8">
                        ...
                        <h5>
                            ...
                            <table>
                                <tr>
                                    <td>
                                    <h5>
                                                <a class="dropdown-item" href="/adsucursal/inicio" style="color: black;">Crear Noticias&nbsp;  
                                    ...
                                    <td>
                                    <h5><a class="dropdown-item" style="color: black;" href="/adsucursal/listado/anuncios">Listar Noticias&nbsp;  
                ...
                <li ><strong>
                    <h5>
                        <a class="nav-link px-8" style="color: aliceblue;" href="/adsucursal/registrar/evento_deportivo" > Eventos Deportivos</a>
