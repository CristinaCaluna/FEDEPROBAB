                    ...
                    <strong>
                        <h5>
                            ...
                            <div class="dropdown-menu dropdown-menu-right mr-md-0" aria-labelledby="bd-versions">
                                <strong>
                                    <h5><a class="dropdown-item" style="color: black;" href="/adsucursal/inicio">Crear Noticias</a></h5>
                                </strong>
                                <strong>
                                    <h5><a class="dropdown-item" style="color: black;" href="/adsucursal/listado/anuncios">Listar Noticias</a></h5>
                                </strong>
                            </div>
                        </h5>
                    </strong>
