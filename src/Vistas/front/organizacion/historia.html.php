    ...
    <div class=" pt-5 col-md-6 tex col-lg-7 rounded-2 p-3 mb-2  text-dark justify-content-end "  >
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body lh-lg">
                ...
                robar o hacer trampas. Implica mostrar respeto
                hacia los demás y tener integridad y conciencia de sí mismo.
            </div>
            </div>
        </div>
        <div class="accordion-item">
            ...
            <div class="accordion-body lh-lg">
            Es la consideración y valoración especial o positiva ante alguien o algo, al que se le reconoce valor social o especial deferencia. Transmite 
            una sensación de admiración por las 
                        cualidades buenas o valiosas y de los derechos de los individuos y de la sociedad.
            </div>
            </div>
        </div>
        <div class="accordion-item">
            ...
            <div class="accordion-body lh-lg">La equidad implica un trato humano, siempre con el fin de lograr igualdad en el ejercicio de derechos, pues todas las 
                personas son sujetos sociales de derechos y justicia. </div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div class="accordion-body lh-lg">Es considerada un valor del ser humano, que se caracteriza por la capacidad del individuo de actuar de la manera correcta
                (o de acuerdo a lo esperado) y comprometerse con propósitos conjuntos. </div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div class="accordion-body lh-lg">Es la capacidad de participar activamente en la prosecución de una meta común subordinando los intereses personales a los 
                objetivos del equipo e institucional. </div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div class="accordion-body lh-lg">En todos los sectores sociales y humanos es fundamental destacar el valor de la unidad, crear siempre puentes de unión para que
                podamos convivir juntos y en armonía, y no solo llevándose bien, sino también buscando la unión.</div>
            </div>
        </div>
        </div>
