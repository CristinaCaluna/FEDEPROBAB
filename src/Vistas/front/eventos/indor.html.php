<br><br><div class="container">
    <div class="row justify-content-center">
        <h2 class="fw-light thead-light text-dark text-center">Eventos deportivos de Indor Fútbol 2024 </h2>
    </div>
    <br>
    <style>
        .table {
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5 justify-content-center" id="staticBackdropLabel">EVENTO DEPORTIVO DE INDOR FUTBOL 2024</h1>
